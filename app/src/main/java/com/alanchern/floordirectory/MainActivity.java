...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        RecyclerView floorRecycler = (RecyclerView) findViewById(R.id.floor_recycler);
        FloorAdapter floorAdapter = new FloorAdapter(numberFloors);
        floorRecycler.setHasFixedSize(true);
        ...
        if (floor != mCurrentFloor) {
            ...
            switch (floor) {
                case 1:
                    ...
                    break;
                case 2:
                    Unit unit2 = new Unit(2, "218C", "Microsoft");
                    unitList.add(unit2);
                    break;
                case 3:
            ...
            UnitFragment unitFragment = UnitFragment.newInstance(unitList);
            transaction.replace(R.id.unit_frame, unitFragment).commit();
        }
    }
